  ...
  sections: [
    {
      ...
      body: [
        "35 field interviews across England, Germany, and France found engineers didn't want a remote desktop connection, they wanted the diagnostic data, fast.",
        'Pivoted the entire design: stop delivering the desktop over a fragile satellite link, start delivering the diagnostics data as a notification and file.',
        "Successful outcomes earned trust and an invitation to interview an entire drill ship's crew off Louisiana, reshaping GE Power Conversion's product roadmap for the whole Marine vertical.",
      ],
      proofPoints: [
        { label: 'NEW REVENUE', value: '$180M, 10-year service contract' },
        { label: 'SPEED', value: <>Time-to-data:<br />6 hours → 15 minutes</> },
        { label: 'CAREER GROWTH', value: "Promoted onto GE's Predix Asset Performance Management team" },
      ],
      imageCount: 2,
